...
export class CalculationUtils {
    ...
    private safeMathEvaluator?: SafeMathEvaluator;

    constructor(
        expressionParser?: ExpressionParser,
        safeMathEvaluator?: SafeMathEvaluator
    ) {
     ...
     */
    parseNumericValue(input: string | number | null | undefined, unit: string | null = null): number | null {
